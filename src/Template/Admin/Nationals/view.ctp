...
<div class="nationals view large-9 medium-8 columns content">
    <h3><?= h($national->name) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($national->shops as $shops): ?>
            <tr>
                <td><?= h($shops->id) ?></td>
                <td><?= h($shops->code) ?></td>
                <td><?= h($shops->name) ?></td>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($national->states as $states): ?>
            <tr>
                <td><?= h($states->id) ?></td>
                <td><?= h($states->national_id) ?></td>
                <td><?= h($states->name) ?></td>
                <td><?= h($states->slug) ?></td>
                <td><?= h($states->rate) ?></td>
                <td class="actions">
