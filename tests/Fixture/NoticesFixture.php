...
class NoticesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'notice_status' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'notice_status' => 1,
            'created' => '2017-03-02 09:09:25',
            'updated' => '2017-03-02 09:09:25',
            'deleted' => 1,
            'deleted_date' => '2017-03-02 09:09:25'
        ],
    ];
}
