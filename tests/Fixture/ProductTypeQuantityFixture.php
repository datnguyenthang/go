...
/**
 * ProductTypeQuantityFixture
 *
 */
class ProductTypeQuantityFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'product_type_quantity';
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 11, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
